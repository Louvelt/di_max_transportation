...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:32px;background:#f0f9ff;">
          ...
          <p style="color:#475569;">We've received your quote request and will get back to you within 2 hours.</p>
          ...
          <p style="color:#475569;">Questions? Call <strong>+1 (774) 625-3852</strong> or email <a href="mailto:info@dimaxtransportation.com" style="color:#127CE0;">info@dimaxtransportation.com</a></p>
    ...
    console.error("Quote email error:", msg);
